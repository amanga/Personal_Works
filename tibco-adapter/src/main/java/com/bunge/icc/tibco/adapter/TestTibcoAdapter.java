...
public class TestTibcoAdapter {

	private static Logger logger = Logger.getLogger(TestTibcoAdapter.class.getName()); 
	...
	public static void main(String args[]) throws InterruptedException{
		TestTibcoAdapter.start(args);
		//sleep for 10 seconds....
		Thread.sleep(10000);
		TestTibcoAdapter.stop();
	}
